...
function updateBossHP() {
  const lifePoints = lifePointBar.getChildByName("lifePoint");
  if (lifePoints) {
    lifePoints.width = (bossPoint / 4) * 20;
  }
}
...
function shootBossBullet() {
  setInterval(() => {
    ...
    const bossBullet = new Graphics().circle(0, 0, 8).fill("rgb(7, 120, 141)");
    bossBullet.width = 20;
